  ...
  <div v-else class="group peer hidden md:block" :data-state="state"
    ...
    <div :class="cn(
      ...
      <div data-sidebar="sidebar"
        class="flex h-full !bg-[#0c202e] w-full flex-col text-sidebar-foreground bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow">
        <slot />
      </div>
    </div>
  </div>
